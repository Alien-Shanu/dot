                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-8 z-20 w-full">
                        ...
                        <form onSubmit={handleSubmit} className="w-full space-y-4">
                            ...
                            <button 
                                type="submit"
                                disabled={loading}
                                className="w-full mt-6 bg-[#ce2424] text-white py-3 rounded-lg font-serif font-bold tracking-widest hover:bg-[#21213e] active:bg-[#21213e] transition-all flex items-center justify-center gap-2 group shadow-lg"
                            >
